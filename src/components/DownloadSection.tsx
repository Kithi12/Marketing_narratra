...
export const DownloadSection = () => {
  return <section id="download" className="pt-32 min-h-screen bg-[#F5F7FF]">
      {/* Background Blobs */}
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          duration: 0.8
            ...
            <h2 className="text-4xl font-bold mb-6 text-[#1E1F36]">
              Make Narratra Yours!!
              <br />
              <span className="text-[#3a5ef0]">Start Your New Reading Journey Today</span>
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <a href="#" className="flex items-center justify-center space-x-3 bg-black text-white px-6 py-4 rounded-xl hover:bg-gray-900 transition-colors">
